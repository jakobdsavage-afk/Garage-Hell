...
export class OilImp {
  ...
  buildMesh() {
    ...
    const bodyMat = new THREE.MeshStandardMaterial({ color: 0x161611, roughness: 0.9 });
    const headMat = new THREE.MeshStandardMaterial({ color: 0x242016, roughness: 0.8 });
    const eyeMat = new THREE.MeshStandardMaterial({ color: 0xff4b1f, emissive: 0xff2b00, emissiveIntensity: 2.4 });
    ...
    const leftEye = new THREE.Mesh(new THREE.SphereGeometry(0.055, 8, 6), eyeMat);
    leftEye.position.set(-0.12, 1.52, -0.29);
    const rightEye = leftEye.clone();
    rightEye.position.x = 0.12;
    const hornMat = new THREE.MeshStandardMaterial({ color: 0x352211, roughness: 0.7 });
    ...
    group.add(body, head, leftEye, rightEye, horn, horn2);
